...
typedef struct {
    I16 drive;                  // 臱笆い(Τ癳猧)1

    I16 sw_limit_plus_stop;     // 笷伐τ氨ゎ1
    I16 sw_limit_minus_stop;    // 
    I16 ELP_stop;               // 
    I16 ELM_stop;               // 
    I16 ALM_stop;               // servo alarmτ氨ゎ1
    I16 emergency_stop;         // emergency_stopτ氨ゎ1
    I16 home_search_error_stop; // 翴い岿粇氨ゎ1
    I16 ORG_stop;               // ORGτ氨ゎ1
    I16 EZ_stop;                // EZτ氨ゎ1

    I16 ORG;                    // ORG单癟腹high/low篈
    I16 EZ;                           
    I16 INP;
    I16 ALM;
    I16 ELP;
