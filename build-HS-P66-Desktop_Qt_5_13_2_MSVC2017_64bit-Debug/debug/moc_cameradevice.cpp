...
#include <memory>
#include "../../HS-P66/Units/cameradevice.h"
...
QT_MOC_LITERAL(3, 24, 14) // "unsigned char*"
    ...
    "CameraDevice\0readReady\0\0unsigned char*"
};
...
void CameraDevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readReady((*reinterpret_cast< unsigned char*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CameraDevice::*)(unsigned char * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraDevice::readReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraDevice::readReady(unsigned char * _t1)
{
